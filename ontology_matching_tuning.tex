...
\begin{subfigure}{0.5\textwidth}
	\centering
\includegraphics[width=0.3\textwidth]{data_figs/benchmark_101_F1-Measure.pdf}
\caption{F1-Measure}
...
\begin{subfigure}{\textwidth}
	\centering
\includegraphics[width=0.3\textwidth]{data_figs/benchmark_248-266_F1-Measure.pdf}
\caption{F1-Measure}
...
\begin{subfigure}{\textwidth}
	\centering
\includegraphics[width=0.3\textwidth]{data_figs/benchmark_248-266_Precision.pdf}
\caption{Precision}
\label{fig:benchmark_248-266_Precision}
\end{subfigure}
\begin{subfigure}{\textwidth}
	\centering
\includegraphics[width=0.3\textwidth]{data_figs/benchmark_248-266_Recall.pdf}
\caption{Recall}
...
According to \ref{fig:benchmark_248-266_F1-Measure}, the method proposed in this paper has certain effects on each ontology matching system (except that the History method will slightly reduce the performance of the Lily system and LogMap system).
